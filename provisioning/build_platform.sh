...
etape "1/8  Fichiers d'environnement"
...
etape "3/8  Environnement Python"
[ -x "$PY" ] || make --no-print-directory venv

etape "4/8  Socle MISP (galaxies, taxonomies, warninglists)"
make --no-print-directory socle-misp

etape "5/8  Pile OpenCTI + socle ATT&CK"
...
etape "6/8  Pont OpenCTI -> MISP"
make --no-print-directory bridge-setup
make --no-print-directory opencti-up

etape "7/8  Socle OpenCTI (rapports STIX publics VIGINUM)"
$PY provisioning/opencti_socle.py --yes

etape "8/8  Connecteurs de flux OpenCTI"
